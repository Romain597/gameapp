...
class Api {
  ...
  getApiAlphabeticListDatas( dataType , updateAlphabeticDatasMethod ) {
      //console.log("getApiAlphabeticListDatas");
      let url = "";
      switch(dataType) {
          case 'studios':
            url = "studios-games-count-by-letter";
          break;
          case 'categories':
            url = "categories-games-count-by-letter";
          break;
          case 'games':
            url = "games-count-by-letter";
          break;
      }
      if( url.trim() !== "" ) {
          return this.#axios.get( url )
              .then(function (response) {
                // handle success
                console.log(response);
                updateAlphabeticDatasMethod(response.data);
              })
              .catch(function (error) {
                // handle error
                console.log(error);
